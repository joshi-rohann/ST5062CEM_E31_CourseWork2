...
def fourth_window():
    ...
    text1 = ttk.Label(window, text="Enter Single Port", background="#072F5F", foreground="white",
                      font=('Times New Roman', 13, 'bold'))
    text1.pack(pady=13)

    input_var = tk.StringVar()
    a = int(input_var.get())
    input_entry = tk.Entry(window, textvariable=a, background="white")
    input_entry.pack(padx=8, pady=14)

    submit_button = tk.Button(window, text="Submit", command=singleportinput)
    submit_button.pack()
